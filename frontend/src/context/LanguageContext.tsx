...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    'checkout.age.desc': 'You must be 18 years or older to purchase Arschwasser products containing alcohol.',
  ...
  de: {
    ...
    'checkout.age.desc': 'Du musst mindestens 18 Jahre alt sein, um Arschwasser-Produkte mit Alkohol zu kaufen.',
